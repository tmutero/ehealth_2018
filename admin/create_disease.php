...
<body>
	...
	<div class="container">
					...
					<div class="panel-heading">Add Disease</div>
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form"  method="post" action="create_disease.php">
								<div class="form-group">
									<label>Disease Name</label>
									<input class="form-control" placeholder="" name="disease">
								</div>
								...
								<div class="form-group">
									...
									<button type="submit" class="btn btn-primary" name="create_disease_btn">Submit Button</button>
